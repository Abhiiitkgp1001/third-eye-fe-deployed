...
import { Plus, Users, Eye, Trash2, Loader2, TrendingUp, MoreVertical, Pencil, Power } from 'lucide-react';
...
export default function PeoplePage() {
  ...
  const updateListMutation = trpc.peopleLists.update.useMutation({
    onSuccess: () => {
      utils.peopleLists.getAll.invalidate();
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto h-full flex flex-col">
      ...
      <Dialog open={!!renameListId} onOpenChange={(open) => !open && setRenameListId(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Rename People List</DialogTitle>
            <DialogDescription>
              Enter a new name for your people list.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
