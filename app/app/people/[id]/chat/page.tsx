...
export default function PeopleListChatPage() {
  ...
  return (
    <div className="flex flex-col h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          <nav aria-label="Breadcrumb" className="mb-3">
            <ol className="flex items-center gap-2 text-xs text-foreground/60 font-base">
              ...
              <li>/</li>
              <li>
                <Link href={`/app/people/${listId}`} className="hover:text-foreground transition-colors">
                  {list.name}
                </Link>
              </li>
              <li>/</li>
      ...
      >
        <ChatInterface listId={listId} listType="people" listName={list.name} />
      </motion.div>
    </div>
  );
}
