            ...
            <div>
              <nav aria-label="Breadcrumb" className="mb-3">
                <ol className="flex items-center gap-2 text-xs text-foreground/60">
                  ...
                  <li>/</li>
                  <li>
                    <Link href="/app/people" className="hover:text-foreground transition-colors">
                      People Lists
                    </Link>
                  </li>
                  <li>/</li>
      ...
      <AlertDialog open={!!showLargeListConfirmDialog} onOpenChange={(open) => !open && setShowLargeListConfirmDialog(null)}>
        <AlertDialogContent className="sm:max-w-md">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-left">
              This list has {showLargeListConfirmDialog?.total} profiles. Estimated validation time: {showLargeListConfirmDialog?.estimatedMinutes} minutes. During validation, you won&apos;t be able to add/remove profiles or modify signals.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
