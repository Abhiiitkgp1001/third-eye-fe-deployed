            ...
            <div className="backdrop-blur-xl bg-jungle-teal-900/95 rounded-2xl border border-jungle-teal-700/40 overflow-hidden">
              <div className="p-6 border-b border-jungle-teal-700/40">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-jungle-teal-600 to-muted-teal-600 hover:from-jungle-teal-700 hover:to-muted-teal-700 text-white font-semibold rounded-lg transition-all flex items-center gap-2"
                  >
              ...
              {companyLists.length === 0 ? (
                <div className="p-12 text-center">
                  ...
                  <p className="text-muted-teal-50 mb-6">Create your first company tracking list to get started</p>
                  <button
                    onClick={() => setIsCreatingList(true)}
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center justify-end gap-2">
                              <button
                                ...
                                className="px-3 py-1.5 bg-gradient-to-r from-jungle-teal-600 to-muted-teal-600 hover:from-jungle-teal-700 hover:to-muted-teal-700 text-white text-sm font-medium rounded-lg transition-all flex items-center gap-1"
                              >
          ...
          <div className="backdrop-blur-xl bg-jungle-teal-900/90 border border-jungle-teal-700/30 rounded-2xl p-8 max-w-md w-full">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-jungle-teal-800/90 border border-jungle-teal-700/30 rounded-lg text-white placeholder-muted-teal-300 focus:outline-none focus:ring-2 focus:ring-jungle-teal-500"
                autoFocus
                onKeyDown={(e) => {
